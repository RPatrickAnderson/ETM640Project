...
ForcastedMissionTravelCosts <- 99000 #current mission related travel forcasted by resource advisor
...
Weights <- as.matrix(c(1,1,1,1,100))
```
...
InstructorChart <- cbind(InstructorNumber,NumTripsAssignedToEachInstructor,NumOfMeritTripsForEachInstructor,
                         InstructorStatus,InstructorMerit,AssignmentByInstructorMatrix)
colnames(InstructorChart)<-list("Instructor","TotalTrips", "MeritTrips", "Active?","MeritStatus", "Trip1", "Trip2", "Trip3")
...
G3 <- matrix(c(MiniumTripsTarget,"SeeIntrChart","SeeIntrChart","SeeIntrChart"),nrow=1)
G4 <- matrix(c(MaxTripsTarget,"SeeIntrChart","SeeIntrChart","SeeIntrChart"),nrow=1)
...
#Model Data
BudgetData <- matrix(c(TotalTravelBudget,MissionTravelCosts,ForcastedMissionTravelCosts,ProDTravelCosts
                       ,TotalRemainingTravelBudget), nrow=1)
colnames(BudgetData )<-list("TotalTravelBudget","MissionTravelCosts","ForcastedMissionTravelCosts",
                            "ProDTravelCosts","TotalRemainingTravelBudget")
rownames(BudgetData )<-list("BudgetData")
